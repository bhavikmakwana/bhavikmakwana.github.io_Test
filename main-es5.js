...
var UsersComponent = /** @class */ (function () {
    ...
    UsersComponent.prototype.getUserData = function () {
        var _this = this;
        this.name = "bhavikmakwana";
        var response = this.http.get("https://api.github.com/users/" + this.name);
        response.subscribe(function (data) {
            _this.result = data;
            console.log('Respone -> ', _this.result);
            return _this.result;
        });
    };
