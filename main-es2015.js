...
module.exports = "<div class=\"d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm\">\n  <h5 class=\"my-0 mr-md-auto font-weight-normal\">Student Management</h5>\n  <nav class=\"my-2 my-md-0 mr-md-3\">\n    <a class=\"btn btn-outline-primary\"  [routerLink]=\"['/dashboard']\" routerLinkActive=\"active\">Dashboard</a>\n  </nav>\n  <nav class=\"my-2 my-md-0 mr-md-3\">\n    <a class=\"btn btn-outline-primary\"  [routerLink]=\"['/users']\" routerLinkActive=\"active\">User</a>\n  </nav>\n   <nav class=\"my-2 my-md-0 mr-md-3\">\n    <a class=\"btn btn-outline-primary\"   [routerLink]=\"['/register']\" routerLinkActive=\"active\">Register</a>\n  </nav>\n</div>\n<!-- Test -->"
...
module.exports = "<div class=\"container\">\n    <h3>Angular Forms </h3>\n    <br>\n    <div class=\"col-md-12\">\n        <form (ngSubmit)=\"submitForm(register)\" #register=\"ngForm\">\n            <div class=\"form-group\">\n              <label for=\"email\">Email address:</label>\n              <input type=\"email\" class=\"form-control\" id=\"email\" name=\"email\" [(ngModel)]=\"email\">\n            </div>\n            <div class=\"form-group\">\n              <label for=\"pwd\">Password:</label>\n              <input type=\"password\" class=\"form-control\" id=\"pwd\" [(ngModel)]=\"password\" name=\"password\">\n            </div>\n            <div class=\"checkbox\">\n              <label><input type=\"checkbox\"> Remember me</label>\n            </div>\n            <button type=\"submit\" class=\"btn btn-default\">Submit</button>\n          </form>\n    </div>    \n</div>"
...
let UsersComponent = class UsersComponent {
    ...
    getUserData() {
        this.name = "bhavikmakwana";
        const response = this.http.get(`https://api.github.com/users/${this.name}`);
        response.subscribe((data) => {
            this.result = data;
            console.log('Respone -> ', this.result);
            return this.result;
        });
    }
};
...
module.exports = __webpack_require__(/*! D:\Code Book\angular\crm-app\src\main.ts */"./src/main.ts");
